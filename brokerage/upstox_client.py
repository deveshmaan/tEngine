...
def load_upstox_credentials(secrets: Optional[object] = None) -> UpstoxConfig:
    ...
    token = 'eyJ0eXAiOiJKV1QiLCJrZXlfaWQiOiJza192MS4wIiwiYWxnIjoiSFMyNTYifQ.eyJzdWIiOiIzR0NMM1kiLCJqdGkiOiI2OTU3NzEzZmY3OGE4NDJmMjUyYjExZmIiLCJpc011bHRpQ2xpZW50IjpmYWxzZSwiaXNQbHVzUGxhbiI6dHJ1ZSwiaWF0IjoxNzY3MzM4MzAzLCJpc3MiOiJ1ZGFwaS1nYXRld2F5LXNlcnZpY2UiLCJleHAiOjE3NjczOTEyMDB9.AeUuNMtF7-YyCZCw2PdN2OcvJzP1VxknuSIML-cgZ0o'
    if not token:
